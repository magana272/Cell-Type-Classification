...
EXPECTED = {
    ...
    'hPancreas': {
        'label_col': 'Celltype',
        'train': {'PP': 356, 'PSC': 444, 'Delta': 793, 'Ductal': 1290, 'Beta': 2966,
                  'Acinar': 1144, 'Alpha': 3136, 'Epsilon': 21, 'Endothelial': 273,
                  'Macrophage': 52, 'Schwann': 13, 'Mast': 25, 'T_cell': 7,
                  'Mesenchymal': 80, 'MHC class II': 0},
        'test': {'PP': 282, 'PSC': 73, 'Delta': 188, 'Ductal': 414, 'Beta': 1006,
                 'Acinar': 209, 'Alpha': 2011, 'Epsilon': 7, 'Endothelial': 16,
                 'Macrophage': 0, 'Schwann': 0, 'Mast': 7, 'T_cell': 0,
                 'Mesenchymal': 0, 'MHC class II': 5},
    },
    'mPancreas': {
        'label_col': 'Celltype',
